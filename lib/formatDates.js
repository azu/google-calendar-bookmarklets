...
function buildDate(dates) {
    ...
    var startDateText = formatDateString(chronoDate.start.date());
    var endDateText = chronoDate.endDate ? formatDateString(chronoDate.end.date()) : null;
